...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAsideAsideComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AsideComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 37,
      vars: 0,
      consts: [["id", "foto"], ["src", "../../assets/foto.jpg", 1, "card-img", "rounded-circle"], [1, "text-white-50", "text-capitalize"], [1, "text-white-50", "text-justify", "m-0"], [1, "text-muted"], [1, "list-group-item", "bg-dark"], [1, "text-light", "text-capitalize"], [1, "list-group"], [1, "text-white-50"], [1, "list-group-item", "bg-dark", "text-capitalize"]],
      template: function AsideComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](5, " hola soy Ezequiel. Desde hace un a\xF1o me dedico al desarrollo y programacion web Frontend bajo el framework Angular, para proyectos independientes, eligiendo antetodo la excelencia y la innovacion para una mejor experiencia del usuario. ");
